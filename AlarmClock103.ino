...
const int8_t H_INC_PIN = D3;
const int8_t M_INC_PIN = D8;

int alarm_hour = 0;
int alarm_minu = 0;
byte alarm_hour_byte = 0;
byte alarm_minu_byte = 0;
...
/************************************************************************
* Interrupt to update Alarm time set
************************************************************************/
ICACHE_RAM_ATTR void AlarmHourInc() {
        ...
        if (EEPROM.commit()) {
          ...
          Serial.println("Alarm HOUR incremented");
...
pinMode(H_INC_PIN, INPUT_PULLUP ); //Alarm hour increase
pinMode(M_INC_PIN, INPUT_PULLUP ); //Alarm minute increase


/************************************************************************
* Load alarm history from EEPROM
************************************************************************/
alarm_hour_byte = EEPROM.read(0);
...
//Alarm hour
attachInterrupt(digitalPinToInterrupt(H_INC_PIN), AlarmHourInc, RISING);
